...
export const Workbench = ({
  ...
  const onRepresentationClick = (representation: Representation) => {
    //invoked when representation is changed in the tab 
    console.log("on representation click:");
  ...
  if (displayedRepresentation) {
    console.log("in workbench: ");
    console.log(displayedRepresentation.docuId);
    ...
    const props: RepresentationComponentProps = {
      ...
      selection,
      setSelection,
      docuId: displayedRepresentation.docuId,
    };
    main = (
