...
export const OnboardAreaErrorModel = ({ editingContextId, selection, setSelection, readOnly }: OnboardAreaProps) => {
    ...
    <div className={styles.onboardArea}>
      ...
      <Grid container justify="center" alignItems="center">
        <Typography variant="h4" align="center" gutterBottom>
          <p>Error</p> 
          Generation of a full mesh is only possible for the routing model.
        </Typography>
      </Grid>
      </div>
    </div>
