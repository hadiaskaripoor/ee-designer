...
public class StereotypeDescriptionRegistryConfigurer implements IStereotypeDescriptionRegistryConfigurer {
    ...
    // Added by Andre
    public static final UUID EED_ID = UUID.nameUUIDFromBytes("my_eed".getBytes()); //$NON-NLS-1$

    // Added by Andre
    public static final UUID SAMPLETOP_ID = UUID.nameUUIDFromBytes("my_sampleTop".getBytes()); //$NON-NLS-1$

    // Added by Amir
    public static final String EED_LABEL = "EED Model"; //$NON-NLS-1$

    // Added by Amir
    public static final String SAMPLETOP_LABEL = "Sample Topology "; //$NON-NLS-1$
    ...
    public void addStereotypeDescriptions(IStereotypeDescriptionRegistry registry) {
        // changed by Amir
        registry.add(new StereotypeDescription(EED_ID, EED_LABEL, this::getEEDContent));
        // added by Amir
        registry.add(new StereotypeDescription(SAMPLETOP_ID, SAMPLETOP_LABEL, this::getSampleTopologyContent));
    }

    // Added by Andre
    private String getEEDContent() {
        return this.stereotypeBuilder.getStereotypeBody(new ClassPathResource("my.eed")); //$NON-NLS-1$
    }

    // Added by Amir
    private String getSampleTopologyContent() {
        return this.stereotypeBuilder.getStereotypeBody(new ClassPathResource("my.sampleTopology")); //$NON-NLS-1$
    }
}
