 ...
 * <!-- end-user-doc -->
 * @see autoDesigner1.AutoDesigner1Package#getAsil_Level()
 * @model instanceClass="autoDesigner1.Asil_Level"
 * @generated
 */
public enum Asil_Level implements Enumerator {
	/**
	 ...
	 * @generated
	 */
	private static final Asil_Level[] VALUES_ARRAY = new Asil_Level[] { QM, ASIL_A, ASIL_B, ASIL_C, ASIL_D, };
	 ...
	 * @generated
	 */
	public static final List<Asil_Level> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
	 ...
	 * @generated
	 */
	public static Asil_Level get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			Asil_Level result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static Asil_Level getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			Asil_Level result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static Asil_Level get(int value) {
		switch (value) {
		case QM_VALUE:
			return QM;
		case ASIL_A_VALUE:
	 ...
	 * @generated
	 */
	private Asil_Level(int value, String name, String literal) {
		this.value = value;
		this.name = name;
