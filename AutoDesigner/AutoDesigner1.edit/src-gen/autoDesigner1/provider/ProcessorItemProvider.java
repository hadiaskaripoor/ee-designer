...
/**
 * This is the item provider adapter for a {@link autoDesigner1.Processor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProcessorItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Processor_name_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Processor_name_feature",
								"_UI_Processor_type"),
						AutoDesigner1Package.Literals.PROCESSOR__NAME, true, false, false,
	...
	protected void addTurbo_boostPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Processor_turbo_boost_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Processor_turbo_boost_feature",
								"_UI_Processor_type"),
						AutoDesigner1Package.Literals.PROCESSOR__TURBO_BOOST, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AutoDesigner1Package.Literals.PROCESSOR__CORES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(AutoDesigner1Package.Literals.PROCESSOR__CORES,
