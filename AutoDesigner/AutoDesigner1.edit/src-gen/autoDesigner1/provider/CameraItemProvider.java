...
/**
 * This is the item provider adapter for a {@link autoDesigner1.Camera} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CameraItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Camera_name_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Camera_name_feature", "_UI_Camera_type"),
						AutoDesigner1Package.Literals.CAMERA__NAME, true, false, false,
	...
	protected void addCammappingPropertyDescriptor(Object object) {
		//		itemPropertyDescriptors
		//				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
		//						getResourceLocator(), getString("_UI_Camera_cammapping_feature"),
		//						getString("_UI_PropertyDescriptor_description", "_UI_Camera_cammapping_feature",
		//								"_UI_Camera_type"),
		//						AutoDesigner1Package.Literals.CAMERA__CAMMAPPING, true, false, true, null, null, null));
	}
