...
/**
 * This is the item provider adapter for a {@link autoDesigner1.ECU} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ECUItemProvider extends NodeItemProvider {
	/**
	...
	protected void addMemoriesPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ECU_memories_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_ECU_memories_feature", "_UI_ECU_type"),
						AutoDesigner1Package.Literals.ECU__MEMORIES, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AutoDesigner1Package.Literals.ECU__MEMORIES);
			childrenFeatures.add(AutoDesigner1Package.Literals.ECU__PROCESSORS);
		}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_ECU_type")
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(AutoDesigner1Package.Literals.ECU__MEMORIES,
				AutoDesigner1Factory.eINSTANCE.createMemory()));

		newChildDescriptors.add(createChildParameter(AutoDesigner1Package.Literals.ECU__PROCESSORS,
