...
/**
 * This is the item provider adapter for a {@link autoDesigner1.Mapping} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MappingItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addM_gurobiPropertyDescriptor(object);
	...
	protected void addNodePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Mapping_node_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Mapping_node_feature", "_UI_Mapping_type"),
						AutoDesigner1Package.Literals.MAPPING__NODE, true, false, true, null, null, null));
	}
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						AutoDesigner1Package.Literals.MAPPING__NAME, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}

	/**
	 * This adds a property descriptor for the Mgurobi feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addM_gurobiPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Mapping_m_gurobi_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Mapping_m_gurobi_feature",
								"_UI_Mapping_type"),
						AutoDesigner1Package.Literals.MAPPING__MGUROBI, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addAppPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Mapping_app_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Mapping_app_feature", "_UI_Mapping_type"),
						AutoDesigner1Package.Literals.MAPPING__APP, true, false, true, null, null, null));
	}
